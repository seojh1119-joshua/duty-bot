...
import altair ㅁimport calendar
import datetime
import gc
import glob
import io
...
def settings_dialog():
    ...
    with tab_s2:
        ...
        infinite_repeat = st.checkbox("연말까지 무한 자동 순환", value=True)
        days_c = st.number_input("적용 일수", min_value=1, max_value=365, value=365, disabled=infinite_repeat)
...
with tab4:
    ...
    st.dataframe(df, use_container_width=True)as alt
